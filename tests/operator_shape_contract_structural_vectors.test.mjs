...
const VECTOR_PATH = new URL('./operator_shape_contract_structural_vectors.json', import.meta.url);
...
test('shared structural legal vectors converge in concrete and bounded TS contracts', () => {
...
test('shared structural illegal vectors have exact TS concrete codes and paths', () => {
