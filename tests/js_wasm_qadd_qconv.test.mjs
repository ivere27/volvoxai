...
test('portable WASM QAdd and QConv2D preserve physical byte storage', {
  timeout: 120_000,
}, async (t) => {
  try {
  ...
  try {
    ...
    await t.test('RequantizeLinear → QConv2D → QAdd remains a direct physical-byte WASM island', async () => {
