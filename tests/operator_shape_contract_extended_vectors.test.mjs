...
import {
  EXTENDED_OPERATOR_SHAPE_FUNCTIONS,
...
const VECTOR_PATH = new URL('./operator_shape_contract_extended_vectors.json', import.meta.url);
...
test('final-v1 shared corpus is closed over all formerly deferred operators', () => {
  ...
  assert.deepEqual(new Set(Object.keys(EXTENDED_OPERATOR_SHAPE_FUNCTIONS)), EXPECTED_OPERATORS);
