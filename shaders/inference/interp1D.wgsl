@group(0) @binding(0) var<storage, read> input : array<f32>;
            ...
            struct Params { in_c : u32, in_l : u32, out_l : u32, batch : u32 }
            ...
            fn main(@builtin(global_invocation_id) global_id : vec3<u32>) {
                ...
                if (i >= params.out_l || c >= params.in_c || b >= params.batch) { return; }
                ...
                let in_base = (b * params.in_c + c) * params.in_l;
                let out_base = (b * params.in_c + c) * params.out_l;
