...
fn weight_main(@builtin(global_invocation_id) gid:vec3<u32>){
 ...
 let kx=i%params.kernel.y;let ky=(i/params.kernel.y)%params.kernel.x;let oc=(i/(params.kernel.y*params.kernel.x))%params.output.z;let c=i/(params.kernel.y*params.kernel.x*params.output.z);var sum=0.0;
