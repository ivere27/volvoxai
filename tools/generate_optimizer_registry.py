...
def load_registry(
    registry_proto: Path,
    operator_vocabulary_proto: Path,
    ...
    kernel = load_kernel_registry(
        kernel_registry_proto, operator_vocabulary_proto
    )
...
def render_python(registry: OptimizerRegistry) -> bytes:
    ...
    lines = [
        ...
        f"OPERATOR_VOCABULARY_SHA256 = {registry.vocabulary_hash!r}",
...
def main() -> int:
    ...
    try:
        ...
        registry = load_registry(
            registry_proto, operator_vocabulary_proto, kernel_proto
        )
