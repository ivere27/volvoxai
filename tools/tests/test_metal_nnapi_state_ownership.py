#!/usr/bin/env python3
"""Reject process-global Metal and NNAPI graph/request/training state."""
...
NNAPI = ROOT / "native/src/backends/nnapi_engine.c"
...
class MetalNnapiStateOwnershipTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.metal = METAL.read_text(encoding="utf-8")
        cls.nnapi = NNAPI.read_text(encoding="utf-8")
