...
from tools.exporter.operator_shape_contracts import (
    NON_SPATIAL_WAVE_B_OPERATOR_SHAPE_CONTRACTS,
...
_VECTOR_PATH = (
    ...
    / "tests"
    / "operator_shape_contract_wave_b_vectors.json"
)
...
class NonSpatialWaveBSharedVectorTests(unittest.TestCase):
    @classmethod
    ...
    def test_schema_and_per_operator_coverage_are_closed(self):
        ...
        self.assertEqual(
            manifest,
            set(NON_SPATIAL_WAVE_B_OPERATOR_SHAPE_CONTRACTS),
        )
...
class NonSpatialWaveBSymbolicDomainTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
    ...
    def test_every_non_spatial_wave_b_operator_accepts_a_symbolic_domain(self):
        ...
        self.assertEqual(
            set(requests), set(NON_SPATIAL_WAVE_B_OPERATOR_SHAPE_CONTRACTS)
        )
    ...
    def test_unrepresentable_wave_b_dynamic_relations_fail_closed(self):
        cases = (
            (
                "Sub",
                {
