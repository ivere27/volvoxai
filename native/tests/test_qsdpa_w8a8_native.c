...
static int run_case(const QSDPATestCase* test, uint32_t seed) {
    ...
    CHECK(qsdpa_i8u8(q, k, v, keep, reference, test->batch, test->seq_q,
                     ...
                     0.019f, test->q_dtype == 2u ? -3 : 123,
                     0.017f, test->k_dtype == 2u ? 5 : 131,
                     0.023f, test->v_dtype == 2u ? -7 : 119,
                     0.031f, test->output_dtype == 2u ? 4 : 127,
...
int main(void) {
    static const QSDPATestCase cases[] = {
        ...
        {1u, 192u, 402u, 320u, 8u, 2u, 2u, 2u, 2u, 0u, 0u},
        {1u, 96u, 96u, 128u, 8u, 3u, 2u, 3u, 3u, 1u, 1u},
        {2u, 48u, 64u, 128u, 8u, 2u, 3u, 2u, 3u, 0u, 2u},
        {2u, 48u, 64u, 128u, 8u, 3u, 3u, 2u, 2u, 0u, 3u},
        {2u, 48u, 64u, 128u, 8u, 2u, 2u, 3u, 3u, 1u, 4u},
        /* Incremental row calls remain on the direct portable route. */
        {1u, 1u, 96u, 128u, 8u, 2u, 2u, 2u, 2u, 0u, 1u},
    };
