/*
 * The exported surface of conv_f32_opt.c, as data.
 *
 * conv_f32_opt.c is compiled twice — once at the build's baseline ISA and once
 ...
 * conv_f32_opt.h for why that is a list instead of per-function declarations.
 *
...
VX_CONV_F32_ENTRY_VOID(void, vx_conv_f32_opt_free_all, (void), ())
