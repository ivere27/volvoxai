 ...
 * what runs on a CPU without AVX2.  conv_f32_opt_avx2.c is the same source at a
 ...
 * library: conv_f32_opt.c reaches into VxEngineState, whose layout depends on
