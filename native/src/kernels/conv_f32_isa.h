#ifndef VOLVOXAI_CONV_F32_ISA_H
#define VOLVOXAI_CONV_F32_ISA_H

/*
 * FP32 convolution kernels, selected by ISA at runtime.
 *
 * conv_f32_isa.c contains hand-written AVX2 bodies behind `#if
...
/* Renaming through the preprocessor keeps conv_f32_isa.c free of any knowledge
...
#define vx_conv_f32_isa_free_all VX_CONV_F32_SYM(vx_conv_f32_isa_free_all)
#endif
