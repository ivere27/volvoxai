...
1. **[Foundations](01-foundations.md)** 🌱🔧🔬 — What a forward pass is. Tensors, graphs,
   operations. The VolvoxAI mental model and its four "tiers." How a model is stored as a *blueprint*.
...
9. **[The Native Engine](09-native-engine-architecture.md)** 🌱🔧🔬 — A freestanding C binary
   running the same blueprint on a desktop, a phone, or a **robot** — CPU + Vulkan/OpenGL/Metal/NNAPI,
   forward **and** backward, with GPU drivers loaded at runtime. This is the *on-device / edge AI* chapter.
